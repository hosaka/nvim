...
mapl("eo", edit_config_file("10_options.lua"), { desc = "Options config" })
mapl("ek", edit_config_file("12_keymaps.lua"), { desc = "Keymaps config" })
mapl("ep", edit_config_file("30_plugins.lua"), { desc = "Plugins config" })
...
global("minicursorword_disable", { name = "cursorword" }):mapl("oW")
