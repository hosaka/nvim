...
nmap_leader("fc", [[<cmd>Pick git_commits choose_type="show_patch"<cr>]], "Commits (all)")
nmap_leader("fC", [[<cmd>Pick git_commits path="%" choose_type="show_patch"<cr>]], "Commits (current)")
